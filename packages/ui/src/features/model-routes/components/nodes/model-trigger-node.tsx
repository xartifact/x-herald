...
function ModelTriggerNodeComponent({ data }: NodeProps<Node<ModelTriggerData>>) {
  ...
  return (
    <div className="rounded-lg border-2 border-blue-500 bg-blue-50 px-4 py-3 shadow-sm min-w-[160px]">
      ...
      <div className="mt-1 font-mono text-sm font-medium text-blue-900 truncate max-w-[180px]">
        {name}
      </div>
      <div className="text-[11px] font-mono text-blue-700/70 truncate max-w-[180px]">
        {modelName}
      </div>
