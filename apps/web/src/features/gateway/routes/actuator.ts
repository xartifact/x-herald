  ...
  return c.json({
    ...
    protocols: [
      {
        ...
        endpoints: [
          ...
          { method: 'POST', path: '/v1/chat/completions', description: 'Chat completion (streaming supported)' },
      ...
      },
      {
        ...
        endpoints: [
          { method: 'GET',  path: '/v1/models',                    description: 'List accessible models' },
          { method: 'POST', path: '/v1/messages',                  description: 'Messages API (streaming supported)' },
          { method: 'POST', path: '/v1/messages/count_tokens',     description: 'Count tokens (proxied to provider)' },
        ],
      },
    ],
    features: {
    ...
    introspection: {
      endpoints: [
        ...
        { method: 'GET', path: '/v1/actuator/models', description: 'Accessible models for current key' },
      ],
    },
  });
});
