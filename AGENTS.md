...
This project is indexed by GitNexus as **x-herald** (6178 symbols, 14677 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
