...
export function extractPerformanceMetrics(params: MetadataExtractionParams): LogMetadata['performance'] | null {
...
export function extractBusinessTags(params: MetadataExtractionParams): LogMetadata['business'] | null {
