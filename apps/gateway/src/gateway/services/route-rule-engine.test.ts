...
describe('getField', () => {
  ...
  it('returns perf.worstAnomalyLevel for perf.anomalyLevel', () => {
    const ctx: RouteContext = { model: 'gpt-4', streaming: false, perf: makePerf({ worstAnomalyLevel: 'critical' }) };
  ...
  it('returns perf.maxAnomalyScore for perf.anomalyScore', () => {
    const ctx: RouteContext = { model: 'gpt-4', streaming: false, perf: makePerf({ maxAnomalyScore: 0.8 }) };
  ...
  it('returns perf.minSuccessRate for perf.successRate', () => {
    const ctx: RouteContext = { model: 'gpt-4', streaming: false, perf: makePerf({ minSuccessRate: 0.99 }) };
  ...
  it('returns perf.maxTtfbP95 for perf.ttfbP95', () => {
    const ctx: RouteContext = { model: 'gpt-4', streaming: false, perf: makePerf({ maxTtfbP95: 2000 }) };
  ...
  it('returns perf.healthyRatio for perf.healthyRatio', () => {
    const ctx: RouteContext = { model: 'gpt-4', streaming: false, perf: makePerf({ healthyRatio: 0.75 }) };
