...
export function resetTransformerRegistry(): void { transformerRegistry.clear(); }
export function resetCircuitBreaker(): void { circuitBreakerRegistry.reset(); }
export function resetRateLimit(): void { rateLimitEngine.reset(); }
export function resetLogEventBus(): void { logEventBus.reset(); }
