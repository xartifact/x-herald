...
export interface Transformer {
  ...
  adaptRequest?(request: StandardRequest, ctx: TransformerContext): Promise<{
    body: unknown;
    url?: string;
    headers?: Record<string, string>;
  }>;
...
export interface TransformerRegistry {
  register(name: string, transformer: Transformer | import('./transformer').TransformerConstructor): void;
