...
export class AnthropicMessagesExecutor {
  ...
  retry(attempt: number, delay: number, lastResponse?: Response): void {
    ...
    circuitBreakerRegistry.recordFailure(this.config.candidate.instance.id, this.circuitBreakerMeta);
  }
