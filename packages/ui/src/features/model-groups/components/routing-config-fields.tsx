...
const ROUTING_STRATEGIES = [
  {
    value: 'priority',
    label: '优先级',
    description: '按实例优先级数值从小到大依次路由，优先级相同时按创建时间排。适合主备场景。',
  },
  {
    value: 'round_robin',
    label: '轮询',
    description: '在同优先级实例间循环分发请求，各实例均等承载流量。适合实例性能相近时。',
  },
  {
    value: 'weighted',
    label: '加权',
    description: '按各实例权重随机分发，权重越高被选中概率越大。适合不同配额或性能差异较大的实例。',
  },
  {
    value: 'least_response_time',
    label: '最快响应',
    description: '优先选择近 15 分钟 TTFB 均值最低的实例，无历史数据的实例按优先级兜底。',
  },
  {
    value: 'cost_optimized',
    label: '成本优化',
    description: '优先选择 Token 单价（input + output 之和）最低的实例，未填写成本的实例排在最后。',
  },
  {
    value: 'smart',
    label: '智能路由',
    description:
      '综合评分（成功率 50% + TTFB 30% + 重试率 15% + 成本 5%），自动选择当前综合表现最优实例。',
  },
] as const
