...
import { Badge, Card, CardContent, CardHeader, CardTitle, ScrollArea } from '../../../shared/components/ui'
    ...
    <Card>
      <CardHeader>
        <CardTitle className="text-base flex items-center justify-between">
          <span>模型列表</span>
          <Badge variant="secondary">{stats.length} / {total} 个模型</Badge>
        </CardTitle>
      </CardHeader>
      <CardContent>
        {isLoading ? (
                  ...
                  >
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-medium font-mono text-sm">{stat.originalModelName}</span>
                      </div>
