...
function ConditionNodeComponent({ data }: NodeProps<Node<ConditionData>>) {
  return (
    <div className="rounded-lg border-2 border-amber-500 bg-amber-500/15 px-4 py-3 shadow-sm min-w-[180px]">
      ...
      <div className="flex justify-between mt-2">
        <div className="text-xs text-green-600 dark:text-green-400">True</div>
        <div className="text-xs text-red-600 dark:text-red-400">False</div>
      </div>
      <Handle
        type="source"
