...
export const requestAttempts = pgTable(
  ...
  (table) => ({
    ...
    candidateIndexIdx: index('idx_request_attempts_candidate_index').on(
      table.requestGroupId,
 ...
 */
export const clientRequestedModels = pgTable(
 ...
 */
export const modelRequestStats = pgTable(
  'model_request_stats',
  {
